...
public class PersistentCookiesStore {
    private static final String LOG_TAG = "PersistentCookiesStore";
    private static final String COOKIES_PREFS = "Cookies_Prefs";
    private final Map<String, ConcurrentHashMap<String, Cookie>> cookies;
    private final SharedPreferences cookiePrefs;

    public PersistentCookiesStore() {
        this.cookies = new HashMap<>();
        this.cookiePrefs = MyApplication.getAppContext().getSharedPreferences(COOKIES_PREFS,0);
